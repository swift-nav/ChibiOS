...
/**
 * @file    ZYNQ7000/wdg_lld.h
 * @brief   ZYNQ7000 WDG Driver subsystem low level driver header.
 *
 * @addtogroup WDG
 * @{
 */
 ...
 */
#if !defined(ZYNQ7000_WDG_USE_PRV_WDT) || defined(__DOXYGEN__)
#define ZYNQ7000_WDG_USE_PRV_WDT              FALSE
#endif
/** @} */
